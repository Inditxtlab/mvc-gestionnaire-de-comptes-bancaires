...
<form action="?action=update_contract" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="montant" name="montantSouscrit" value="<?= $contract->getMontant() ?>" required>
    </div>
    <div class="mb-3">
        <label for="IdClient" class="form-label">Client Id:</label>
        <input type="text" class="form-control" id="idclient" name="idCLient" value="<?= $contract->getidClient() ?>" required>
    </div>
    <div class="mb-3">
        <label for="duree" class="form-label">Duree du contract:</label>
